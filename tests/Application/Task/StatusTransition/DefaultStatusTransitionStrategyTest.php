...
use App\Application\Task\StatusTransition\DefaultStatusTransitionStrategy;
use App\Domain\Task\ValueObject\TaskStatus;
use PHPUnit\Framework\TestCase;

final class DefaultStatusTransitionStrategyTest extends TestCase
{
    private DefaultStatusTransitionStrategy $strategy;

    protected function setUp(): void
    {
        $this->strategy = new DefaultStatusTransitionStrategy();
    }
    ...
    public function testBlocksDoneToTodo(): void
    {
        $this->assertFalse(
